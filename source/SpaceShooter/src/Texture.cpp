...
void Texture::LoadTexture(const char* name, const char* file)
{
	Texture texture;
...
void Texture::Generate(unsigned int width, unsigned int height, unsigned char* data)
{
	...
	this->wrap_s = GL_REPEAT;// Powtarza teksture w osi x
	this->wrap_t = GL_REPEAT;// Powtarza teksture w osi y
	this->filter_min = GL_LINEAR; //Zwraca œredni¹ wa¿on¹ 4 pikseli otaczaj¹cych podane wspó³rzêdne.
