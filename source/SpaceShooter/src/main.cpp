...
{
    glfwInit();
    // Wskazówki dotycz¹ce wersji major 3, minor 3 = ver.  3.3
    ...
    // Funkcja do przechwytywania wciœniêtych klawiszy gdy okno jest aktywne 
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        //przetwarza zdarzenia które ju¿ s¹ w kolejce 
        glfwPollEvents();
        game.OnProcessInput();
