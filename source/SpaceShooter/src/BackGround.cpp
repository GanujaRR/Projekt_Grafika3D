...
{
	renderer->Draw(Texture::GetTexture("bg"), Shader::GetShader("sprite"), position, rotation, scale, glm::vec4(1));
	renderer->Draw(Texture::GetTexture("bg"), Shader::GetShader("sprite"), second_position, rotation, scale, glm::vec4(1));
}
